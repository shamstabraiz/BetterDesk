...
// EnrollmentRequest is sent by the codenextremote desktop client on first connect.
type EnrollmentRequest struct {
	...
	DeviceType string `json:"device_type,omitempty"` // "codenextremote", "rustdesk", "os_agent", etc.
