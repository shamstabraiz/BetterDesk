...
> **Status:** The SDK Studio visual builder is planned for Phase 14 of the codenextremote 3.0 roadmap.
...
├── requirements.txt   # codenextremote-cdap + dependencies
...
├── config.json        # Server URL, device ID, API key
├── package.json       # codenextremote-cdap + dependencies
