# codenextremote Enterprise Feature Roadmap

> Analysis based on Axence nVision feature specification mapped onto codenextremote
...
| 6.6 | Remote desktop (RDP-like) | **DONE** | — | Core codenextremote feature — screen sharing + control |
| 6.7 | Non-disruptive user session access | **DONE** | — | codenextremote agent allows shadowing without logoff |
...
| 9.3 | Remote assistance support | **DONE** | — | Core codenextremote remote desktop |
...
Files to create:
```
codenextremote-client/src-tauri/src/inventory/
  mod.rs
...
codenextremote-client/src-tauri/src/helpdesk/
  mod.rs
...
Files to create:
```
codenextremote-client/src-tauri/src/activity/
  mod.rs
...
codenextremote-client/src-tauri/src/automation/
  mod.rs
  script_runner.rs
...
Files to create:
```
codenextremote-client/src-tauri/src/dataguard/
  mod.rs
  usb_monitor.rs
  file_watcher.rs
  policy_enforcer.rs
...
Files to create:
```
codenextremote-client/src-tauri/src/file_transfer/
  mod.rs
  sender.rs
  receiver.rs
  browser.rs
...
*Document auto-generated by analysis of Axence nVision specification against codenextremote architecture.*
