# codenextremote Console — Implementation Plan v3.0
...
| **codenextremote Agent** | Go binary, gopsutil, cross-platform | Production |
...
- [ ] Auto-detection of devices running codenextremote agent
