...
This directory contains comprehensive documentation for codenextremote Console, organized by topic.
...
- **[codenextremote Client](architecture/BETTERDESK_CLIENT_ARCHITECTURE.md)** — Desktop client architecture
- **[codenextremote v3 Overview](architecture/BETTERDESK_v3_OVERVIEW.md)** — v3 architecture summary
...
> **Note:** The original Rust-based HBBS patch has been replaced by the [Go server](../codenextremote-server/) and moved to `archive/`. See the main [README](../README.md) for current architecture.
