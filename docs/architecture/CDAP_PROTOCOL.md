...
> **Server Version**: codenextremote v3.0.0  
...
CDAP (Custom Device API Protocol) is a WebSocket-based protocol that connects non-RustDesk devices to the codenextremote ecosystem. It provides:
...
| Remote desktop (CDAP agent) | ✅ Yes | codenextremote native agent |
...
codenextremote-server --tls-cert /path/to/cert.pem --tls-key /path/to/key.pem
...
```python
from codenextremote_cdap import CDAPBridge, Widget, WidgetType

bridge = CDAPBridge(
    server="ws://codenextremote.example.com:21122",
...
|--------|----------|--------|
| `codenextremote-bridge-modbus` | Modbus TCP/RTU | v3.0 |
| `codenextremote-bridge-snmp` | SNMP v2c/v3 | v3.0 |
| `codenextremote-bridge-rest` | REST webhook | v3.0 |
| `codenextremote-bridge-mqtt` | MQTT 3.1.1/5.0 | Planned |
| `codenextremote-bridge-opcua` | OPC UA | Planned |
...
*Last updated: March 2026 — codenextremote v3.0.0*
