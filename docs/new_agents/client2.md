...
- łatwej rejestracji do serwera codenextremote,
...
1. rejestruje urządzenie w serwerze codenextremote,
...
Podczas instalacji klienta Agent ma pojawić się monit o wpisanie adresu serwera codenextremote.
...
Na bazie aktualnego projektu `codenextremote`:
...
## Oczekiwany rezultat
Wygeneruj kompletną koncepcję i implementację **codenextremote Agent Client**, obejmującą:
- architekturę,
- strukturę katalogów,
- proces instalacji,
- onboarding serwera,
