...
// Platform-aware default path (C:\codenextremote on Windows, /opt/rustdesk on Linux)
const isWindows = process.platform === 'win32';
const defaultPath = isWindows ? 'C:\\codenextremote\\db_v2.sqlite3' : '/opt/rustdesk/db_v2.sqlite3';
