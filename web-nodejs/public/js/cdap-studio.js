/**
 * codenextremote Console — CDAP SDK Studio
...
(function () {
    ...
    const NODE_DEFS = {
        ...
        'device-telemetry': { cat: 'sources', icon: 'developer_board',   label: 'Device Telemetry', desc: 'codenextremote agent metrics', ports: { in: 0, out: 1 }, config: { deviceId: '', metrics: 'cpu,memory,disk' } },
    ...
    function getCsrf() {
        return window.codenextremote && window.codenextremote.csrfToken
            ? { 'x-csrf-token': window.codenextremote.csrfToken }
            : {};
    }
