/**
 * codenextremote Console — Widget Plugin System
                ...
                c.querySelectorAll('.widget-qc-btn').forEach(function (btn) {
                    btn.addEventListener('click', function (e) {
                        ...
                        if (action === 'connect' && id) {
                            ...
                            fetch(url, { method: 'POST', headers: { 'X-CSRF-Token': (window.codenextremote || {}).csrfToken || '' } })
    ...
    register('shell-command', {
        ...
        _exec: function (body, config) {
            ...
            fetch('/api/system/exec', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'X-CSRF-Token': (window.codenextremote || {}).csrfToken || '' },
