...
function readAdminCredentialsFile() {
    ...
    if (process.platform === 'win32') {
        candidates.push('C:\\Yomie', 'C:\\Yomie\\data',
...
async function generateTotpSetup(userId) {
    ...
    const otpauthUrl = authenticator.keyuri(user.username, 'Yomie Console', secret);
