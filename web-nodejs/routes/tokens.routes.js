/**
 * codenextremote Console - Device Token Routes
...
router.get('/api/panel/tokens', requireAuth, requirePermission('enrollment.manage'), async (req, res) => {
    try {
        ...
        const result = await codenextremoteApi.listDeviceTokens(includeRevoked);
        res.json(result);
    } catch (err) {
...
router.post('/api/panel/tokens', requireAuth, requirePermission('enrollment.manage'), async (req, res) => {
    try {
        const result = await codenextremoteApi.createDeviceToken(req.body);
        res.json(result);
    } catch (err) {
...
router.post('/api/panel/tokens/generate-bulk', requireAuth, requirePermission('enrollment.manage'), async (req, res) => {
    try {
        const result = await codenextremoteApi.bulkGenerateTokens(req.body);
        res.json(result);
    } catch (err) {
...
router.put('/api/panel/tokens/:id', requireAuth, requirePermission('enrollment.manage'), async (req, res) => {
    try {
        const result = await codenextremoteApi.updateDeviceToken(req.params.id, req.body);
        res.json(result);
    } catch (err) {
...
router.delete('/api/panel/tokens/:id', requireAuth, requirePermission('enrollment.manage'), async (req, res) => {
    try {
        const result = await codenextremoteApi.revokeDeviceToken(req.params.id);
        res.json(result);
    } catch (err) {
...
router.post('/api/panel/tokens/:id/bind', requireAuth, requirePermission('enrollment.manage'), async (req, res) => {
    try {
        const result = await codenextremoteApi.bindTokenToPeer(req.params.id, req.body.peer_id);
        res.json(result);
    } catch (err) {
...
router.get('/api/panel/enrollment/mode', requireAuth, requirePermission('enrollment.manage'), async (req, res) => {
    try {
        const result = await codenextremoteApi.getEnrollmentMode();
        res.json(result);
    } catch (err) {
...
router.put('/api/panel/enrollment/mode', requireAuth, requirePermission('enrollment.manage'), async (req, res) => {
    try {
        const result = await codenextremoteApi.setEnrollmentMode(req.body.mode);
        res.json(result);
    } catch (err) {
