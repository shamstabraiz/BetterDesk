#!/bin/bash
# =============================================================================
# codenextremote Server - Interactive Build Script
# =============================================================================
...
#
# Usage:
#   ./build-codenextremote.sh              # Interactive mode
#   ./build-codenextremote.sh --auto       # Non-interactive (use defaults)
#   ./build-codenextremote.sh --clean      # Clean build directory
#   ./build-codenextremote.sh --help       # Show help
#
# Requirements:
...
show_help() {
    echo "codenextremote Server - Build Script"
    echo ""
...
apply_modifications() {
    print_header "Applying codenextremote Modifications"
    ...
    print_step "Copying codenextremote modifications..."
    ...
    print_step "Updating Cargo.toml with codenextremote dependencies..."
...
# codenextremote HTTP API dependencies\
...
chrono = { version = "0.4", features = ["serde"] }' Cargo.toml
    ...
    print_success "codenextremote modifications applied successfully"
}
...
build_binaries() {
    print_header "Building codenextremote Binaries"
...
main() {
    ...
    echo ""
    echo -e "${CYAN}╔══════════════════════════════════════════════════════════╗${NC}"
    echo -e "${CYAN}║${NC}     ${BOLD}codenextremote Server - Build from Source${NC}               ${CYAN}║${NC}"
    ...
    echo -e "${GREEN}codenextremote binaries have been built successfully!${NC}"
    echo ""
