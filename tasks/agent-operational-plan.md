...
**Implementacja:** agent-client pobiera większość z natywnego `codenextremote-agent` (Go) — portować moduły do Rust lub uruchamiać jako sidecar subprocess.
...
- `protobuf` — protokół (reuse z codenextremote-server/proto)
...
- Strona z brandingiem firmy: logo, nazwa, opis, "Pobierz codenextremote Agent" × OS.
