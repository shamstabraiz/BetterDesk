...
- Before declaring i18n completeness in this repo, inventory every active translation system separately: web-nodejs/lang for the web console, codenextremote-client/src/locales for the desktop client, and exclude archive/installer language channels unless the user explicitly asks to include them.
