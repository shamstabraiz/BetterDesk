<#
.SYNOPSIS
    codenextremote Server - Interactive Build Script for Windows

.DESCRIPTION
    This script automates building codenextremote enhanced binaries from source.
    It handles downloading RustDesk sources, applying codenextremote modifications,
...
.EXAMPLE
    .\build-codenextremote.ps1
    Interactive build

.EXAMPLE
    .\build-codenextremote.ps1 -Auto
    Build with defaults

.EXAMPLE
    .\build-codenextremote.ps1 -Version 1.1.15
...
function Show-HelpMessage {
    Write-Host "codenextremote Server - Build Script"
    Write-Host ""
    Write-Host "Usage: .\build-codenextremote.ps1 [OPTIONS]"
    Write-Host ""
    Write-Host "Options:"
    ...
    Write-Host ""
    Write-Host "Examples:"
    Write-Host "  .\build-codenextremote.ps1                 # Interactive build"
    Write-Host "  .\build-codenextremote.ps1 -Auto           # Build with defaults"
    Write-Host "  .\build-codenextremote.ps1 -Version 1.1.15 # Build specific version"
    Write-Host ""
}
...
# ============================================================================
# Apply codenextremote Modifications
# ============================================================================

function Apply-Modifications {
    Write-Header "Applying codenextremote Modifications"
    ...
    try {
        ...
        Write-Step "Copying codenextremote modifications..."
        ...
        Write-Success "codenextremote modifications applied successfully"
        return $true
    } catch {
...
function Build-Binaries {
    Write-Header "Building codenextremote Binaries"
...
function Generate-Checksums {
    ...
    try {
        ...
        $content = @"
# codenextremote Server - Binary Checksums

Generated: $dateNow
RustDesk Base Version: $Script:RustDeskVersion
codenextremote Version: 2.0.1
...
function Main {
    ...
    Write-Host ""
    Write-Host "  ========================================================" -ForegroundColor Cyan
    Write-Host "  codenextremote Server - Build Script (Windows)              " -ForegroundColor Cyan
    Write-Host "  ========================================================" -ForegroundColor Cyan
    Write-Host ""
    ...
    Write-Host ""
    Write-Host "  2. Install using codenextremote.ps1:"
    Write-Host "     .\codenextremote.ps1"
    Write-Host ""
}
