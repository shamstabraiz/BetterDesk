...
func DefaultConfig() *Config {
	...
	fileRoot := "/var/lib/codenextremote-agent/files"
	if runtime.GOOS == "windows" {
		fileRoot = filepath.Join(os.Getenv("ProgramData"), "codenextremote", "AgentFiles")
		if fileRoot == filepath.Join("", "codenextremote", "AgentFiles") {
			fileRoot = `C:\ProgramData\codenextremote\AgentFiles`
		}
	}
...
func defaultDataDir() string {
	if runtime.GOOS == "windows" {
		return filepath.Join(os.Getenv("ProgramData"), "codenextremote", "Agent")
	}
	return "/var/lib/codenextremote-agent"
}
