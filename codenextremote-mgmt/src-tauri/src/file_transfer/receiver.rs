/// codenextremote Agent — File Receiver
///
...
const DOWNLOAD_SUBDIR: &str = "codenextremote_downloads";
...
impl FileReceiver {
    ...
    /// Files are saved to the user's Downloads/codenextremote_downloads directory.
    pub fn new() -> Self {
...
mod tests {
    ...
    fn test_unique_path_nonexistent() {
        let path = std::env::temp_dir().join("codenextremote_nonexistent_test_12345.txt");
