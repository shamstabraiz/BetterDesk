//! codenextremote native WebSocket relay client.
//!
//! Connects to the codenextremote console relay endpoint (`/ws/bd-relay`) for
//! E2E-encrypted data transfer between two codenextremote desktop clients.
//!
//! Flow:
...
/// Active relay connection to a remote codenextremote client.
