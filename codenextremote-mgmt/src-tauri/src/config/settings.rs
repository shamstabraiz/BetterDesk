...
//!   - Windows: %APPDATA%/codenextremote/config.json
//!   - Linux:   ~/.config/codenextremote/config.json
//!   - macOS:   ~/Library/Application Support/codenextremote/config.json
...
pub struct Settings {
    ...
    /// API port for codenextremote HTTP API
    pub api_port: u16,
    /// Whether to use RustDesk-compatible protocol
    pub rustdesk_compat: bool,
    /// Whether to use codenextremote native protocol (enhanced security)
    ...
    /// codenextremote console URL (e.g. http://192.168.0.110:5000)
    pub console_url: String,
    /// Access token for codenextremote API authentication
...
impl Settings {
    ...
    pub fn config_path() -> Result<PathBuf> {
        let dirs = directories::ProjectDirs::from("com", "codenextremote", "codenextremote")
    ...
    /// Get the codenextremote console API base URL (for native protocol).
    ///
    ...
    /// Get `host:port` for WebSocket connections to the codenextremote console.
    ///
