...
pub fn add_firewall_rules_impl() {
    ...
    let rules = [
        ("codenextremote Signal TCP", "21116", "TCP", "in"),
        ("codenextremote Signal UDP", "21116", "UDP", "in"),
        ("codenextremote Relay",     "21117", "TCP", "in"),
        ("codenextremote WS Signal", "21118", "TCP", "in"),
        ("codenextremote WS Relay",  "21119", "TCP", "in"),
    ];
