//! codenextremote native E2E encryption for relay sessions.
//!
//! Uses X25519 Diffie-Hellman + XSalsa20-Poly1305 to establish a shared
//! symmetric key between two codenextremote desktop clients.  The server
...
//!   5. Derive key:   symmetric_key = SHA256(shared_secret ‖ "codenextremote-E2E-v1")
...
const DOMAIN_SEPARATOR: &[u8] = b"codenextremote-E2E-v1";
...
mod tests {
    ...
    fn test_key_exchange_and_encrypt_decrypt() {
        ...
        let plaintext = b"Hello from codenextremote!";
