...
//!
//! Log file location: `<config_dir>/logs/codenextremote-mgmt.log`
//! - Windows: `%APPDATA%\codenextremote\codenextremote\logs\codenextremote-mgmt.log`
//! - Linux:   `~/.config/codenextremote/logs/codenextremote-mgmt.log`
//!
//! Features:
...
impl Log for DualLogger {
    ...
    fn log(&self, record: &Record) {
        ...
        // Shorten module paths: codenextremote_mgmt_lib::commands → commands
        let short_target = target
            .strip_prefix("codenextremote_mgmt_lib::")
            .unwrap_or(target);
...
pub fn init(is_console: bool) {
    ...
    let log_path = get_log_dir().join("codenextremote-mgmt.log");
