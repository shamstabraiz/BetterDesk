...
from codenextremote_cdap.protocol import Message, auth_payload_api_key, auth_payload_device_token, auth_payload_user_password
from codenextremote_cdap.widgets import Widget

logger = logging.getLogger("codenextremote_cdap")


class CDAPBridge:
    """Python bridge that connects to a codenextremote CDAP gateway."""
