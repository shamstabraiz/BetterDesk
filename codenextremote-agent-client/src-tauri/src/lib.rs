//! codenextremote Agent Client — lightweight endpoint device agent.
//!
//! Architecture:
...
pub fn run() {
    ...
    info!(
        "codenextremote Agent v{} (pid={}) — boot",
    ...
    tauri::Builder::default()
        ...
        .expect("Failed to start codenextremote Agent");
}
